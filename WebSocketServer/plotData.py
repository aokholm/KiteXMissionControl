...
with open('sessions/2016-08-04T19:01:03.972Z-session-Sucess.json') as data_file:
...
z = [kinematic['pos']['z'] for kinematic in kinematics]

pprint([kinematic['vel']['z']   for kinematic in kinematics])
